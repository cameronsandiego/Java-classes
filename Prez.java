...
public class Prez
{
    ...
    {
        //String nationalEmbarrassment
    	Scanner keyboard = new Scanner(System.in);
    	System.out.print("Who did you vote for?");
        String president = keyboard.nextLine();

        String nationalEmbarrassment = president.replace("Trump", "cheetoh-brain");
    	while (nationalEmbarrassment != president){
        //{

    	System.out.printf("You voted for: %s%n", nationalEmbarrassment);
        }
        /*else {
         //   System.out.printf("You voted for: %s%n", nationalEmbarrassment);
       // }
        /*/
    	/*int fun = 699/10;
    	Scanner keyboard = new Scanner(System.in); //to make a new string of class type keyboard that we 
    	
    	String lunch = new String ("tacos"); //to make a new string of type lunch
